                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">
                                    Where are walk-in locations at?</a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">
                                    What if I have a problem after-hours?</a>
                            </h4>
                        </div>
                        <div id="collapse3" class="panel-collapse collapse">
                            <div class="panel-body">
                                <p>
                                    <i>myCommunity</i> is a free service for RMIT students where you can easily ask other students for advice.<br/>
                                    <a href="https://community.its.rmit.edu.au/" target="_blank">myCommunity</a>
                                </p>
                            </div>
                        </div>
                    </div>
